...
export const InfoBuscar = styled.div`
  display: flex;
...
export const ModalBackDroop = styled.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
export const ModalBuscarContainer = styled.div`
  background: white;
  padding: 20px;
  border-radius: 8px;
  width: 500px;
...
export const ModalBuscarContent = styled.div`
  display: flex;
  flex-direction: column;
